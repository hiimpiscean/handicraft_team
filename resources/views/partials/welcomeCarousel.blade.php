        ...
        <div class="carousel-item welcome-carousel-image2">
            <div class="container">
                <div class="carousel-caption text-left">
                    ...
                    <p><a class="btn btn-lg btn-primary" href="piesubscription" role="button">Sign up today</a></p>
                </div>
            </div>
        </div>
        <div class="carousel-item welcome-carousel-image3">
            <div class="container">
                <div class="carousel-caption text-right">
                    ...
                    <p><a class="btn btn-lg btn-primary" href="fruitpies" role="button">Fruit pies</a></p>
                </div>
            </div>
        </div>
    </div>
