...
@section('main')
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-4">
        <img width="175" height="175" src="{{asset('images/handicraf/rotre.jpg')}}">
      ...
      <div class="col-md-4">
        <img width="175" height="175" src="{{asset('images/handicraf/ro.PNG')}}">
        <h2>Cranberry pie</h2>
        <p>A Christmas favorite</p>
        <p><a class="btn btn-primary" href="{{route('pie.applepie')}}" role="button">View details</a></p>
      </div>
      <div class="col-md-4">
        <img width="175" height="175" src="{{asset('images/handicraf/rotre1.PNG')}}">
        <h2>Pumpkin pie</h2>
